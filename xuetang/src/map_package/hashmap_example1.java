...
public class hashmap_example1 {
	public static void main(String[] args){
        ...
        System.out.println("判断key里面是否含有"+"key1: "+map1.containsKey("key1"));
        ...
        System.out.println("getValue="+params.get("key1"));
        ...
        System.out.println("containsKey="+params.containsKey("key1"));
